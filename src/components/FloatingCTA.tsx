...
const FloatingCTA = () => {
  ...
  const sectionStyle = getSectionStyle(config, "floating-cta");

  return (
    <>
      <div
        className="fixed bottom-0 left-0 right-0 z-50 flex border-t border-border bg-card/95 backdrop-blur-lg md:hidden"
        style={sectionStyle}
      >
        <button
